...
module ApplicationHelper
  ...
  def copyright_generator
    DevcampViewTool::Renderer.copyright 'Retador Co., Ltd.', 'All rights reserved'
  end
  ...
  def alert_generator(msg)
    js add_gritter(msg, title: 'Takayuki Doi Portfolio', sticky: false)
  end
end
